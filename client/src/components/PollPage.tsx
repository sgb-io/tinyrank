...
export function PollPage({
  ...
  const pollUrl = `${window.location.origin}/poll/${code}`;
  ...
  const handleSetUsername = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!res.ok) {
        setUsernameError("Failed to set name");
        return;
      }
    ...
    <div className="poll-page">
      ...
      <div className="poll-header">
          ...
          {editingTitle ? (
            <div className="title-edit">
              <input
                ...
                autoFocus
              />
              <button className="btn btn-primary" onClick={handleRenameTitle}>
                Save
              </button>
              <button
                className="btn btn-ghost"
        ...
        <div className="poll-meta">
          ...
          <div className="poll-meta-right">
            {isOwner && <span className="owner-badge">👑 Owner</span>}
            {session.username && (
              <span className="username-badge">
                🙋 {session.username}
                <button
                  className="btn btn-ghost change-name-btn"
        ...
        {isOwner && (
          <div className="owner-controls">
            <button className="btn btn-danger" onClick={handleDeletePoll}>
              🗑 Delete Poll
            </button>
          </div>
        )}
